...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    foreach ($schedule_data as $day => &$times) {
        // Vérification et mise à jour des horaires pour chaque jour
            ...
            <form action="update_hours.php" method="post">
                <?php foreach ($schedule_data as $day => $times): ?>
                    <div class="day-schedule">
                        ...
                        <input type="time" name="<?php echo $day; ?>_morning_opening_hour" id="<?php echo $day; ?>_morning_opening_hour" value="<?php echo htmlspecialchars($times['morning_opening_hour'] ?? '08:00'); ?>">

                        <label for="<?php echo $day; ?>_morning_closing_hour">Heure de fermeture (matin):</label>
                        <input type="time" name="<?php echo $day; ?>_morning_closing_hour" id="<?php echo $day; ?>_morning_closing_hour" value="<?php echo htmlspecialchars($times['morning_closing_hour'] ?? '12:00'); ?>">

                        <label for="<?php echo $day; ?>_afternoon_opening_hour">Heure d'ouverture (après-midi):</label>
                        <input type="time" name="<?php echo $day; ?>_afternoon_opening_hour" id="<?php echo $day; ?>_afternoon_opening_hour" value="<?php echo htmlspecialchars($times['afternoon_opening_hour'] ?? '14:00'); ?>">

                        <label for="<?php echo $day; ?>_afternoon_closing_hour">Heure de fermeture (après-midi):</label>
                        <input type="time" name="<?php echo $day; ?>_afternoon_closing_hour" id="<?php echo $day; ?>_afternoon_closing_hour" value="<?php echo htmlspecialchars($times['afternoon_closing_hour'] ?? '18:00'); ?>">
                    </div>
                <?php endforeach; ?>
